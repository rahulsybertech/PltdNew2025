...
package com.syber.ssspltd.response.NewDashboadRespo;
...
public class BalanceTillDatePojo {
    ...
    private List<PendingOrderDetail> mPendingOrderDetails;
    ...
    public List<PendingOrderDetail> getPendingOrderDetails() {
        return mPendingOrderDetails;
    }

    public void setPendingOrderDetails(List<PendingOrderDetail> pendingOrderDetails) {
        mPendingOrderDetails = pendingOrderDetails;
    }
