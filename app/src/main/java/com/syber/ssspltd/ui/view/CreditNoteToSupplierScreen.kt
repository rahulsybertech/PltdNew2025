package com.syber.ssspltd.ui.view
...
@Composable
fun CreditNoteToSupplierScreen(
        ...
        topBar = {
            Surface(
                ...
                TopAppBar(
                    title = {
                        Column {
                            Text("Credit note to supplier", fontSize = 18.sp, fontWeight = FontWeight.Bold, color = Color.White)
