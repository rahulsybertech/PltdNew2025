...
public class StayBooking implements Parcelable {
    private String id;
    ...
    // Constructor
    public StayBooking(String id, String companyID, String branchID, String checkInDate, String checkInTime, String checkoutDate, String checkoutTime, String noOfPerson,String branchName) {
        this.id = id;
    ...
    protected StayBooking(Parcel in) {
        id = in.readString();
