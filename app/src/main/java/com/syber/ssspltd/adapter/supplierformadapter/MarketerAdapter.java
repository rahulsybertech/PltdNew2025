...
public class MarketerAdapter extends RecyclerView.Adapter<MarketerAdapter.MyViewHolder> {

    private Activity mContext;
    private List<MarketerModel> data;

    public MarketerAdapter(Activity mContext, List<MarketerModel> data) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final MarketerModel product;
        product = data.get(position);
        holder.name.setText(product.getMarketerName());
