...
public class CustomerDialogAdapter extends RecyclerView.Adapter<CustomerDialogAdapter.MyViewHolder>  {
    ...
    private List<CustomerListResult> data;

    public static int pq;

    public CustomerDialogAdapter(Activity mContext, List<CustomerListResult> data) {
        this.mContext = mContext;
        this.data = data;
    }

    @Override
    public CustomerDialogAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.sarch_list, parent, false);
        return new CustomerDialogAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(final CustomerDialogAdapter.MyViewHolder holder, final int position) {

        final CustomerListResult product;
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((ChooseCategries) mContext).setCustomerList(data.get(getAdapterPosition()));
