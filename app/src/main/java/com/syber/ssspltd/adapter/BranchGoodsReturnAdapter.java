...
public class BranchGoodsReturnAdapter extends RecyclerView.Adapter<BranchGoodsReturnAdapter.MyViewHolder> {
    ...
    public BranchGoodsReturnAdapter(Context mContext, List<BranchEmployeesResult> detailList) {
        this.mContext = mContext;
        this.branchesDetails = detailList;
    }

    @Override
    public BranchGoodsReturnAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.branch_billing, parent, false);
        return new BranchGoodsReturnAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(BranchGoodsReturnAdapter.MyViewHolder holder, final int position) {
