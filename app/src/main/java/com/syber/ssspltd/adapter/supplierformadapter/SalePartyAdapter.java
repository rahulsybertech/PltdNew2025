...
public class SalePartyAdapter extends RecyclerView.Adapter<SalePartyAdapter.MyViewHolder> {

    private Activity mContext;
    private List<SalepartyModel> data;

    public SalePartyAdapter(Activity mContext, List<SalepartyModel> data) {
