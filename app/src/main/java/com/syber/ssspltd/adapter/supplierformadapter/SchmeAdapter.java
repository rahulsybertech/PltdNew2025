...
public class SchmeAdapter extends RecyclerView.Adapter<SchmeAdapter.MyViewHolder> {
    ...
    public SchmeAdapter(Activity mContext, List<SchemeModel> data) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        final SchemeModel product;
        product = data.get(position);
        holder.name.setText(product.getScheme());
