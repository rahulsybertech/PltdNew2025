...
public class GodownPackingAdapter extends RecyclerView.Adapter<GodownPackingAdapter.MyViewHolder> {


    private Context mContext;
    private List<BranchEmployeesResult> branchesDetails;

    public GodownPackingAdapter(Context mContext, List<BranchEmployeesResult> detailList) {
        this.mContext = mContext;
        this.branchesDetails = detailList;
    }

    @Override
    public GodownPackingAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.branch_billing, parent, false);
        return new GodownPackingAdapter.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(GodownPackingAdapter.MyViewHolder holder, final int position) {
